...
win = pygame.image.load("placar/win.png")


score1 = 0
score1_img = pygame.image.load("placar/score/0.png")
score2 = 0
score2_img = pygame.image.load("placar/score/0.png")
...
def move_ball():
    ...
    if ball_x < -50:
        ...
        ball_dir *= -1
        score2 += 1
        score2_img = pygame.image.load("placar/score/" + str(score2) + ".png")
